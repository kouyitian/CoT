    ...
    def generate_objects_per_room(self, args):
        ...
        if use_constraint:
            ...
            if self.constraint_type == "llm":
                ...
                history_constraint = constraint.format(history_chat["floor_obj"], deficiency)
                constraint_plan = self.llm(history_constraint+constraint_prompt)
                # constraint_plan = history_chat["floor_obj"].split("Agent:")[-1]
                history_chat["floor_obj"]="User:{} \n Agent:{}".format(history_constraint+constraint_prompt, constraint_plan)
                history_chat["floor_obj"] = "{}".format(constraint_plan)
